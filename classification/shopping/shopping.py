...
def load_data(filename):
    ...
    df['Month'] = df['Month'].map({'Jan': 0, 'Feb': 1, 'Mar': 2, 'Apr': 3, 'May': 4, 'June': 5, 'Jul': 6, 'Aug': 7, 'Sep': 8, 'Oct': 9, 'Nov': 10, 'Dec': 11})
...
def evaluate(labels, predictions):
    ...
    sensitivity = correct_positive / actual_positive
    specificity = correct_negative / actual_negative
